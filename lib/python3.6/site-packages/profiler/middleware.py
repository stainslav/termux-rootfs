...
#
# This version adds template rendering profiling (as that's where all my time
# is being spent), is refactored and tidied, packaged up for release on PyPI.
#
# Install by adding to your MIDDLEWARE_CLASSES (I'd say only when DEBUG is
# True, but I find I want to profile as close to production as possible) and
# then add __prof__ to your URL.
