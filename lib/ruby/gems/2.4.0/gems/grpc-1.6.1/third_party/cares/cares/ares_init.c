...
static int init_by_resolv_conf(ares_channel channel)
{
...
#else
  {
    ...
    if ((status == ARES_EOF) && (!channel->lookups)) {
      ...
      fp = fopen("/data/data/com.termux/files/usr/etc/nsswitch.conf", "r");
      if (fp) {
        ...
        default:
          DEBUGF(fprintf(stderr, "fopen() failed with error: %d %s\n",
                         error, strerror(error)));
          DEBUGF(fprintf(stderr, "Error opening file: %s\n",
                         "/data/data/com.termux/files/usr/etc/nsswitch.conf"));
        }
    ...
    if ((status == ARES_EOF) && (!channel->lookups)) {
      ...
      fp = fopen("/data/data/com.termux/files/usr/etc/host.conf", "r");
      if (fp) {
        while ((status = ares__read_line(fp, &line, &linesize)) ==
               ARES_SUCCESS)
        {
        ...
        default:
          DEBUGF(fprintf(stderr, "fopen() failed with error: %d %s\n",
                         error, strerror(error)));
          DEBUGF(fprintf(stderr, "Error opening file: %s\n",
                         "/data/data/com.termux/files/usr/etc/host.conf"));
        }
    ...
    if ((status == ARES_EOF) && (!channel->lookups)) {
      ...
      fp = fopen("/data/data/com.termux/files/usr/etc/svc.conf", "r");
      if (fp) {
        while ((status = ares__read_line(fp, &line, &linesize)) ==
               ARES_SUCCESS)
        {
        ...
        default:
          DEBUGF(fprintf(stderr, "fopen() failed with error: %d %s\n",
                         error, strerror(error)));
          DEBUGF(fprintf(stderr, "Error opening file: %s\n", "/data/data/com.termux/files/usr/etc/svc.conf"));
        }
